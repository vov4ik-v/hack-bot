...
def get_broadcast_inline_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="У командах і пройшли тестове", callback_data="broadcast:in_teams_passed_test"),
                InlineKeyboardButton(text="У командах і не пройшли тестове", callback_data="broadcast:in_teams_not_passed_test"),
            ],
            [
